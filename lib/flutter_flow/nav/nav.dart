...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'newscontent',
          path: '/newscontent',
          builder: (context, params) => NewscontentWidget(
        ...
        FFRoute(
          ...
          path: '/listviewnews',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'listviewnews')
              : ListviewnewsWidget(),
        ),
        FFRoute(
          name: 'CreateAccount2',
        ...
        FFRoute(
          name: 'Themeselector',
          path: '/themeselector',
          builder: (context, params) => ThemeselectorWidget(),
        ),
        FFRoute(
          name: 'newscontentCopy',
          path: '/newscontentCopy',
          builder: (context, params) => NewscontentCopyWidget(
            docref: params.getParam(
              'docref',
              ParamType.DocumentReference,
              isList: false,
