...
import 'schema/magazine_record.dart';
...
export 'schema/magazine_record.dart';
...
/// Functions to query MagazineRecords (as a Stream and as a Future).
Future<int> queryMagazineRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MagazineRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MagazineRecord>> queryMagazineRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MagazineRecord.collection,
      MagazineRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MagazineRecord>> queryMagazineRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
